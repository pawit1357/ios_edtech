...
namespace {
    ...
    const char* textureFilenames[NUM_AUGMENTATION_TEXTURES] = {
        ...
        "icon_loading.png",
        "icon_error.png",
        "01_cover_media_1.png",
        "01_cover_media_2.ong",
        "media_3.png",
        "media_4.png"
    };
...
- (void) prepare {
    ...
    for (int i = 0; i < NUM_VIDEO_TARGETS; ++i) {
        ...
        switch (i) {
            case 0:
                filename = @"01_mangroves.mp4";
                break;
            case 1:
                filename = @"02_sunami.mp4";
                break;
            case 2:
                filename = @"Fig_Animation.mp4";
                break;
            default:
                filename = @"jungle.mp4";
                break;
...
- (void)renderFrameQCAR
{
    ...
    for (int i = 0; i < numActiveTrackables; ++i) {
        ...
        if (strcmp(imageTarget.getName(), "vdo2") == 0)
        {
            playerIndex = 1;
        }
        else if (strcmp(imageTarget.getName(), "vdo3") == 0)
        {
            playerIndex = 2;
        }
        else if (strcmp(imageTarget.getName(), "vdo4") == 0)
        {
            playerIndex = 3;
        }
